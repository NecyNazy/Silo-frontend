...
export function ForbiddenScreen() {
  return (
    <div className="flex min-h-svh flex-col items-center justify-center gap-3 bg-canvas px-4 text-center">
      ...
      >
        <p className="text-sm font-semibold tracking-widest text-danger">403</p>
        <h1 className="text-xl font-semibold text-text-primary">Access denied</h1>
        <p className="text-sm text-text-muted">Your account doesn't have access to this page.</p>
